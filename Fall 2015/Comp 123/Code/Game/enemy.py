...
class Game:
    def __init__(self,master):
        ...
        #setup enemies--------------------------
        enemy1 = Squirrel(self,x=550,y=350,speedX=1,speedY = 1, shotFreq = 100)
...
class Player:
    ...
    #BINDINGS---------------------------------   
        ...
        #root.bind('<Key-Right>', self.right)
...
#MOVE----------------------------------------------------------------------------------              
    ...
    def check_collision(self):
        ...
        overlapping = Game.c.find_overlapping(playerCoords[0],playerCoords[1],playerCoords[2],playerCoords[3])[2:]
...
class Squirrel:
    ...
    def update(self):
        ...
        #move_dot=Game.c.create_oval(x+1,y+1,x-1,y-1,fill="black")
        ...
        #for key in Game.walls.keys():
            ...
            ##LEFT
            #if abs(x - wallX2)<=self.bufx:
                #if wallY1<= y-self.bufy <= wallY2 or wallY1<=y+self.bufy <=wallY2:
                    #self.dirX = self.dirX*-1
            ##RIGHT      
            #if abs(x - wallX1)<=self.bufx:
                #if wallY1<= y-self.bufy <= wallY2 or wallY1<=y+self.bufy <=wallY2:
                    #self.dirX = self.dirX*-1
            ##UP        
            #if abs(y - wallY2)<=self.bufy:
                #if wallX1<= x-self.bufx <= wallX2 or wallX1<=x+self.bufx <=wallX2:
                    #self.dirY = self.dirY*-1
            ##DOWN        
            #if abs(y - wallY1)<=self.bufy:
                #if wallX1<= x-self.bufx <= wallX2 or wallX1<=x+self.bufx <=wallX2:
                    #self.dirY = self.dirY*-1
   #movement------------------------
        self.check_collision()
